/**
 * eg: npm run create-template --dirname=xxx
 */
const fs = require('fs')
const path = require('path')

const from_path = path.resolve(
  __dirname,
  process.env.npm_package_config_from_path
)

const dirname = process.env.npm_config_dirname

const to_path = path.resolve(
  __dirname,
  process.env.npm_package_config_to_path + `/${dirname}`
)
